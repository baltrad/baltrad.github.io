...
<img src="https://render.githubusercontent.com/render/math?math=S_j = \frac{ P^j_{Zhh} \,\cdot \, P^j_{height}[w_{Zdr} \,\cdot \,P^j_{Zdr} %2B w_{\rho hv}\,\cdot \,P^j_{\rho{hv}} %2B w_{Kdp}\,\cdot \,P^j_{Kdp}]}{w^j_{Zdr} %2B w^j_{\rho_{hv}} %2B w^j_{Kdp}}" />
